    ...
    def forward(self, inps, agents=None, return_q=True, return_all_q=False,
        ...
        for i_heads in range(self.attend_heads):
            for agentN in self.agents:
                ...
                # tot_attend_prob = (agent_attend_probs[agentN][i_heads] + clst_probs_extended[agentN][i_heads]) / 2.0
                tot_attend_prob = agent_attend_probs[agentN][i_heads] * torch.exp(1 + 10 * clst_probs_extended[agentN][i_heads])
